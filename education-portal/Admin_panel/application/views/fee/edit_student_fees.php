    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Edit Student Fees
            <small>Edit Student Fees</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Fees</a></li>
            <li class="active">Edit Student Fees</li>
          </ol>
        </section>
                ...
                <div class="col-md-8">
                    <div class="box">
                        <div class="box-header">
                           <p><strong>Edit Student Fees  </strong></p>
                        </div>
                        <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select class="form-control" name="standard" id="standard" style="width: 100%;">
                                            ...
                                            <?php foreach($school_standard as $standard){
                                                ?> 
                                                <option <?php if($standard->standard_id== $student_fee_row->standard_id){echo "selected";} ?>  value="<?php echo $standard->standard_id; ?>" data-standardid="<?php echo $standard->standard_id; ?>"><?php echo $standard->standard_title; ?></option>
                                                <?php
                                            } ?>
                                        </select> 
                                    </div>
                                      ...
                                      <div class="col-md-12">
                                        <label for="fee_title">Select Student <span class="red">*</span></label>
                                         <select class="text-input form-control" id="student_id" name="student_id">
                                                ...
                                                ?> 
                                                <option <?php if($student->student_id== $student_fee_row->student_id){echo "selected";} ?>  value="<?php echo $student->student_id; ?>" ><?php echo $student->student_user_name; ?></option>
                                                <?php
                                            } ?>
                                            </select>
                                    </div>
                                     <div class="col-md-12">
                                       ...
                                       <select class="text-input form-control" id="fee_types" name="fee_types">
                                                <option value="0">No Fees Type</option>
                                                  <?php foreach($fees_types as $fees_type){
                                                ?> 
                                                <option <?php if($fees_type->id== $student_fee_row->fee_types){echo "selected";} ?>  value="<?php echo $fees_type->id; ?>" ><?php echo $fees_type->title; ?></option>
                                                <?php
                                            } ?>
                                            </select>
                                    </div>
                                     <div class="col-md-12">
                                        <label for="fee_amount">Fees Amount <span class="red"></span></label>
                                         <input type="text" name="fee_amount" id="fee_amount" class="form-control"  value="<?php echo $student_fee_row->fee_amount; ?>" readonly="" placeholder="00"/>
                                     </div>
                                     <div class="col-md-12">
                                        <label for="fee_amount">Pay Fees Amount <span class="red"></span></label>
                                         <input type="text" name="pay_fee_amount" id="pay_fee_amount" class="form-control"  value="<?php echo $student_fee_row->pay_fee_amount; ?>"  placeholder="00"/>
                                     </div>
                                    <div class="col-md-12">
                                        <label for="pay_date">Date <span class="red">*</span></label>
                                        <input type="text" class="form-control" id="pay_date" name="pay_date" placeholder="Show Date" data-inputmask="'alias': 'yyyy/mm/dd'" value="<?php echo $student_fee_row->pay_date; ?>">
                                    </div>
                                    </div>
                                </div>
            ...
            $.ajax({
              ...
              .done(function( data ) {
                     ...
                     $.each(data, function(index, element) {
                                ...
                                $('#fee_amount').val(element.base_amount);
                            });
